...
public class CalendarViewController implements ViewController {
    ...
    private Map<Integer, List<DatedSyllabusEntity>> createCalendarMap(List<DatedSyllabusEntity> datedSyllabusEntities) {
        ...
        for (DatedSyllabusEntity syllabusItem: datedSyllabusEntities) {
            int syllabusItemDate = syllabusItem.getDueDate().getDayOfMonth();
    ...
    //make method to get the complete set of syllabus items
    //private Map<Integer, List<DatedSyllabusEntity>> getCalendarMonth(ZonedDateTime dateFocus) {
    //    List<DatedSyllabusEntity> datedSyllabusEntities =new ArrayList<>();
    //    int year = dateFocus.getYear();
    //    int month = dateFocus.getMonthValue();
        //get syllabus items and add them to datedSyllbusEntities then run it through createCalendarMap
     //   return createCalendarMap(datedSyllabusEntities);
    //}
